...
//        talon.changeControlMode(ControlMode.PercentOutput); // used to be voltage
...
//
//        talon.setStatusFrameRateMs(WPI_TalonSRX.StatusFrameRate.General, config.GENERAL_STATUS_FRAME_RATE_MS);
